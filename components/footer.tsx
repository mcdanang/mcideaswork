      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-gray-100">McIdeas Work</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://teman-sejati.com" target="_blank" rel="noopener noreferrer" 
                   className="text-gray-400 hover:text-blue-400 transition-colors">
                  Teman Sejati
                </a>
              </li>
              <li>
                <a href="https://wrotels.com" target="_blank" rel="noopener noreferrer"
                   className="text-gray-400 hover:text-blue-400 transition-colors">
                  Wrotels
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2 text-gray-400">
                ...
                <a href="mailto:support@mcideas.work" className="hover:text-blue-400 transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400">
            © {new Date().getFullYear()} PT McIdeas Work Digital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
